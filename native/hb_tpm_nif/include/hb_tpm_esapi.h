#ifndef HB_TPM_ESAPI_H
#define HB_TPM_ESAPI_H
...
// TPM Enhanced System API
#include <tss2/tss2_esys.h>   
// TPM Command Transmission Interface Loader
...
// Max size for PCR values (SHA512 = 64 bytes)
#define TPM_MAX_PCR_VALUE_SIZE 64    
// Max size for TPM quote/attestation data
#define TPM_MAX_QUOTE_SIZE 2048    
 // Max random bytes per TPM_GetRandom call
#define TPM_MAX_RANDOM_SIZE 64    
// Max digest size (SHA512 = 64 bytes)
#define TPM_MAX_DIGEST_SIZE 64      
// Max size for data to be signed directly
#define TPM_MAX_SIGN_DATA_SIZE 1024  
 ...
 */
typedef struct {
    // TSS2 Enhanced System API context
    ESYS_CONTEXT* esys_context;
    // Flag indicating if context is properly initialized
    bool initialized;
} tpm_context_t;
