...
-export([bundle_hint/4, data/4, tags/5, excluded_tags/3]).
-export([to/7, siginfo/4, fields_to_tx/4]).
...
%% extraction and tag exclusion rules.
to(Device, TABM, Req, ToFun, FieldsFun, ExcludedTagsFun, Opts) ->
    MaybeCommitment =
