...
enforce_valid_tx_test() ->
    ...
    FailureCases = [
        ...
        {quantity_not_integer, BaseTX#tx{quantity = <<"100">>},
            {invalid_field, quantity, <<"100">>}},
        {data_size_not_integer, BaseTX#tx{data_size = an_atom},
            {invalid_field, data_size, an_atom}},
        ...
        {signature_invalid_type, BaseTX#tx{signature = "hello"},
            {invalid_field, signature, "hello"}},
        ...
        {denomination_not_integer, BaseTX#tx{denomination = <<"1">>},
            {invalid_field, denomination, <<"1">>}},
