...
%% @doc Commit a message through tx@1.0 with an ECDSA secp256k1 wallet and
%% assert the resulting ecdsa-secp256k1-sha256 commitment verifies offline.
ecdsa_commit_test() ->
    ...
    ?event(debug_test, {ecdsa_committed, {explicit, Committed}}),
