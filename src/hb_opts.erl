...
default_message() ->
    #{
        ...
        preloaded_devices => [
            ...
            #{<<"name">> => <<"arweave-spora@2.9">>, <<"module">> => dev_arweave_spora},
            #{<<"name">> => <<"arweave-vdf@2.9.5">>, <<"module">> => dev_arweave_vdf},
            #{<<"name">> => <<"arweave-ledger@2.9.5">>, <<"module">> => dev_arweave_ledger},
            #{<<"name">> => <<"arweave-gossip@2.9.5">>, <<"module">> => dev_arweave_gossip},
