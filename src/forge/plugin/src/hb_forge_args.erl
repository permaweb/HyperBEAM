...
opts() ->
    [
        ...
        {external_signer, undefined, "external-signer", string,
            "Command to externally sign tx@1.0 publish transaction JSON."},
...
parse(State, DefaultOutput) ->
    ...
    ExternalSignerRaw = proplists:get_value(external_signer, Args, undefined),
    ...
    #{
        ...
        <<"external-signer">> => maybe_bin(ExternalSignerRaw),
