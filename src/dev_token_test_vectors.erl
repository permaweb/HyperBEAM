...
transfer_basic_test() ->
    ...
    ComputeResult = hb_ao:resolve(Base, Req, Opts),
...
mint_then_transfer_test() ->
    ...
    TransferReq = generate_assignment(
        <<"transfer">>,
        #{
            <<"from">> => ?ALICE,
            <<"recipient">> => ?BOB,
