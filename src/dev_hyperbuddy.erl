...
info() ->
    #{
        ...
        routes => #{
            ...
            <<"bundle.js">> => <<"bundle.js">>,
            <<"fonts.css">> => <<"fonts.css">>,
            <<"font-open-sans.ttf">> => <<"font-open-sans.ttf">>,
            <<"font-titillium-web-bold.ttf">> => <<"font-titillium-web-bold.ttf">>,
            <<"font-titillium-web-regular.ttf">> => <<"font-titillium-web-regular.ttf">>,
            <<"font-titillium-web-semibold.ttf">> => <<"font-titillium-web-semibold.ttf">>,
            <<"font-source-code-pro-regular.ttf">> => <<"font-source-code-pro-regular.ttf">>,
            <<"font-source-code-pro-medium.ttf">> => <<"font-source-code-pro-medium.ttf">>,
            <<"font-source-code-pro-semibold.ttf">> => <<"font-source-code-pro-semibold.ttf">>,
            <<"font-source-code-pro-bold.ttf">> => <<"font-source-code-pro-bold.ttf">>,
            % Error pages:
            <<"404.html">> => <<"404.html">>,
            <<"500.html">> => <<"500.html">>,
