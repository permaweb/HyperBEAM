...
pot_state(User, Resource, Quantity, Weight, MintCap, MintPropNumerator, MintPropDenominator) ->
    Deposits = #{
        User => #{
            <<"quantity">> => Quantity,
...
pot_state_multi(Resource, UserQuantities, Weight, MintCap, MintPropNumerator, MintPropDenominator) ->
...
pot_state_empty(EmptyResources, MintCap, MintPropNumerator, MintPropDenominator) ->
