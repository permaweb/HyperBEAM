...
-export([vdf_backend_info_nif/0]).
-export([vdf_sha2_nif/5, vdf_sha2_fused_nif/5, vdf_sha2_hiopt_nif/5]).
-export([vdf_parallel_sha_verify_with_reset_nif/10]).

%%%===================================================================
%%% Public interface.
%%%===================================================================
vdf_backend_info_nif() ->
