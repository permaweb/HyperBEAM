...
%% VENDOR: the log terms carried an encoded indep_hash; the raw binary is
...
%% VENDOR: mainnet applies the supplied accounts directly; testnet-only wallet
%% crediting is outside this validator.
update_accounts5(B, Accounts, Args) ->
	{MinerReward, EndowmentPool, DebtSupply, KryderPlusRateMultiplierLatch,
			KryderPlusRateMultiplier} = Args,
