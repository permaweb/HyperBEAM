...
simple_blocks_query_parallel_test() ->
    Opts =
        #{
            <<"priv-wallet">> => ar_wallet:new(),
...
block_by_height_query_parallel_test() ->
    Opts =
        #{
            <<"priv-wallet">> => ar_wallet:new(),
            <<"store">> => [hb_test_utils:test_store()],
...
simple_ans104_query_parallel_test() ->
    Opts =
        #{
...
transactions_query_owners_parallel_test() ->
    Opts =
        #{
            <<"priv-wallet">> => Wallet = ar_wallet:new(),
            <<"store">> => [hb_test_utils:test_store()]
...
transactions_query_recipients_parallel_test() ->
    Opts =
        #{
            <<"priv-wallet">> => ar_wallet:new(),
            <<"store">> => [hb_test_utils:test_store()]
...
transactions_query_ids_parallel_test() ->
    Opts =
        #{
            <<"priv-wallet">> => ar_wallet:new(),
            <<"store">> => [hb_test_utils:test_store()]
...
transactions_query_sort_by_block_parallel_test() ->
...
transactions_query_filter_by_block_parallel_test() ->
    {ok, Node, Opts} = test_env_with_blocks(1892159, 1892158),
    EarlierID = <<"xBpOR2KOjYEgv5HmddMlAgYa-yMvfEVl-0XzRIfm2uY">>,
    LaterID = <<"HVr7EpRhlPkbwdnoXKHf25p7BPa0qJOs6C7XueLthA0">>,
    VerifyFun =
...
transactions_query_filter_by_block_excludes_unknown_offsets_parallel_test() ->
...
transactions_query_ids_preserve_arweave_tx_id_parallel_test() ->
...
transactions_query_cursor_by_offset_parallel_test() ->
    {ok, Node, Opts} = test_env_with_blocks(1892159, 1892158),
    EarlierID = <<"xBpOR2KOjYEgv5HmddMlAgYa-yMvfEVl-0XzRIfm2uY">>,
    LaterID = <<"HVr7EpRhlPkbwdnoXKHf25p7BPa0qJOs6C7XueLthA0">>,
...
transaction_query_by_id_parallel_test() ->
    Opts =
        #{
            <<"priv-wallet">> => ar_wallet:new(),
            <<"store">> => [hb_test_utils:test_store()]
...
transaction_query_full_parallel_test() ->
    Opts =
        #{
...
transaction_query_with_anchor_parallel_test() ->
    Opts =
        #{
            <<"priv-wallet">> => Wallet = ar_wallet:new(),
            <<"store">> => [hb_test_utils:test_store()]
