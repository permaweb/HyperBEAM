...
\titleformat{\chapter}[hang]{\Huge\bfseries\color{Ink}}{\thechapter}{0.65em}{}
...
\subsection{Likelihood and information measures}\label{sec:information}
...
\section{Failure and determinism boundaries}
...
\chapter{Deployment and audit}\label{sec:deployment}
