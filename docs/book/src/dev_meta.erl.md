...
[View source on GitHub](https://github.com/permaweb/HyperBEAM/blob/edge/src/dev_meta.erl)
...
*Generated from [dev_meta.erl](https://github.com/permaweb/HyperBEAM/blob/edge/src/dev_meta.erl)*
