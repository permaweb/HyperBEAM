...
[View source on GitHub](https://github.com/permaweb/HyperBEAM/blob/edge/src/ar_rate_limiter.erl)
...
*Generated from [ar_rate_limiter.erl](https://github.com/permaweb/HyperBEAM/blob/edge/src/ar_rate_limiter.erl)*
