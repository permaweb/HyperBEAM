...
[View source on GitHub](https://github.com/permaweb/HyperBEAM/blob/edge/src/dev_snp_nif.erl)
...
*Generated from [dev_snp_nif.erl](https://github.com/permaweb/HyperBEAM/blob/edge/src/dev_snp_nif.erl)*
