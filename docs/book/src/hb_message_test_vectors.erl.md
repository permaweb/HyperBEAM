...
[View source on GitHub](https://github.com/permaweb/HyperBEAM/blob/edge/src/hb_message_test_vectors.erl)
...
Run the test suite for a set of codecs, using the given options type.
...
### codec_roundtrip_conversion_is_idempotent_test
...
### nested_message_with_large_keys_and_content_test
...
### nested_message_with_large_content_test
...
### deeply_nested_message_with_content_test
...
### deeply_nested_message_with_only_content
...
### specific_order_signed_message_test
...
### message_with_simple_embedded_list_test
...
### empty_string_in_nested_tag_test
...
### signed_message_with_derived_components_test
...
### large_body_committed_keys_test
...
### encode_large_balance_table_test
...
### sign_deep_message_from_lazy_cache_read_test
...
### id_of_deep_message_and_link_message_match_test
...
*Generated from [hb_message_test_vectors.erl](https://github.com/permaweb/HyperBEAM/blob/edge/src/hb_message_test_vectors.erl)*
