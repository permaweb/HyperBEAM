...
[View source on GitHub](https://github.com/permaweb/HyperBEAM/blob/edge/src/hb_name.erl)
...
*Generated from [hb_name.erl](https://github.com/permaweb/HyperBEAM/blob/edge/src/hb_name.erl)*
