...
[View source on GitHub](https://github.com/permaweb/HyperBEAM/blob/edge/src/hb_cache_render.erl)
...
*Generated from [hb_cache_render.erl](https://github.com/permaweb/HyperBEAM/blob/edge/src/hb_cache_render.erl)*
