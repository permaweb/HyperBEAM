...
[View source on GitHub](https://github.com/permaweb/HyperBEAM/blob/edge/src/dev_poda.erl)
...
*Generated from [dev_poda.erl](https://github.com/permaweb/HyperBEAM/blob/edge/src/dev_poda.erl)*
