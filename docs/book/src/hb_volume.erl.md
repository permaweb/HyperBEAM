...
[View source on GitHub](https://github.com/permaweb/HyperBEAM/blob/edge/src/hb_volume.erl)
...
*Generated from [hb_volume.erl](https://github.com/permaweb/HyperBEAM/blob/edge/src/hb_volume.erl)*
