...
To quickly check if your node is running and accessible, you can send a request to its `~meta@1.0` device (assuming default port 8734):
...
*   **Scheduler Device:** Learn how to [set up a Scheduler device](./reference/setting-up-a-scheduler-device.md) to announce your node as an AO scheduler.
